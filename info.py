...
PICS = (environ.get('PICS', 'https://graph.org/file/496ec32d34750348448c9.jpg')).split()
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MoviezAddaKar')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MoviezAddaKA')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MoviezAdda_Kannada')
